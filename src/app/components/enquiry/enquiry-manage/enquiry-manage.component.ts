...
export class EnquiryManageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.myOptions = [
      { name: 'Assigned Name', id: 'assigned_name' },
      { name: 'Email', id: 'email' },
      { name: 'Enquiry No', id: 'enquiry_no' },
      { name: 'Enquiry Date', id: 'enquiry_date' },
      { name: 'Follow up Date', id: 'followUpDate' },
      { name: 'Follow type', id: 'follow_type' },
      ...
      { name: 'Update Date', id: 'updateDate' }
    ];
