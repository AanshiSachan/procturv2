...
export class EcourseMappingComponent implements OnInit {
  ...
  addCourseOrStandard() {
    console.log('addCourseOrStandard');
  ...
  getEcourseMappingData() {
    ...
    this._http.getData(objecturl).subscribe((data: any) => {
      ...
      this.ecourseDataSource = this.ecourseData;
      this.totalRecords = this.ecourseData.length;
      this.ecourseData = this.getDataFromDataSource(this.pageIndex);
  ...
  fetchTableDataByPage(index) {
    ...
    this.ecourseData = this.getDataFromDataSource(startindex);
  }
